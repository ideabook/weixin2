 ...
 */
package com.example.qiao.weixin2.wave;
...
public class WaveView extends View {
    ...
    // paint to draw wave
    private Paint mViewPaint, mViewPaint2;
     ...
     *                       <br/>Result of waveShiftRatio multiples width of WaveView is the
     *                       length to shift.
     */
     ...
     *
     * @param amplitudeRatio Default to be 0.05. Result of amplitudeRatio + waterLevelRatio
...
//        createShader();
    ...
    private void createShader() {
        ...
        mDefaultWaterLevel = getHeight() * waveHeight;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mViewPaint2.setTextSize(100f);
        mViewPaint2.setColor(Color.RED);
        mViewPaint2.getTextBounds(text2, 0, text2.length(), bounds2);
        canvas.drawText(text2, getWidth() / 2-bounds2.width()/2, getHeight() / 2+bounds2.height()/2,
                mViewPaint2);
        ...
        if (mShowWave && mWaveShader != null) {
            ...
            // this decides the size(mWaveLengthRatio for width, mAmplitudeRatio for height) of
// waves
            ...
            // this decides the start position(mWaveShiftRatio for x, mWaterLevelRatio for y)
// of waves
